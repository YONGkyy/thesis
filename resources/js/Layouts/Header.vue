...
<template>
    <header
        ...
        <div class="flex items-center">
            <button class="mr-2 text-gray-500 focus:outline-none lg:hidden" @click="sidebar.toggle">
                <ChevronLeftSquare v-if="sidebar.isOpen" class="w-6 h-6 dark:text-gray-100" />
        ...
        <div class="flex items-center">
            ...
            <button class="flex mr-3 text-gray-600 transition-all duration-500 ease-in transform dark:text-gray-400"
                :class="appTheme === 'dark' ? 'rotate-[360deg]' : 'rotate-0'" @click="toggleTheme">
                <Moon v-if="appTheme === 'dark'" class="w-6 dark:text-gray-100" />
                <Sun v-else class="w-6 h-6 dark:text-gray-100" />
            </button>
            <button class="flex mr-3 text-gray-600 focus:outline-none dark:text-gray-400">
